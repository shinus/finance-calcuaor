var lenght = document.getElementById("length_input_id");
...
function showResult() {
    ...
    div1.innerHTML = "<b>Rectangular Surface Area:  " + result.toFixed(0) + " meters2 </b>";
